...
// Onepilot fork: the built-in Copilot extension is removed (see docs/strip). We keep the ripgrep
// dependency filters (they operate on node_modules) but drop the copilot extension build + shim.
...
// Onepilot fork: the copilot ripgrep-shim packaging task was removed with the Copilot extension. docs/strip.
