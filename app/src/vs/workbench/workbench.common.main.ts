...
// Update
// Onepilot fork: auto-update + release-notes UI disabled (a fork must not pull Microsoft's update feed
// / code.visualstudio.com release notes). See docs/strip/residual-audit.md.
// import './contrib/update/browser/update.contribution.js';

// Surveys
// Onepilot fork: NPS / language feedback surveys removed (telemetry-style cruft). See docs/strip.
...
// Onepilot fork: the "VS Code editor playground" walkthrough is removed (VS Code-specific tutorial). docs/strip.
