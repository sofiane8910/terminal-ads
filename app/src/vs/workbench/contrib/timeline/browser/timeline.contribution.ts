...
import { ONEPILOT_HIDE_EXPLORER_EXTRAS } from '../../../../base/common/onepilot.js';
...
// Onepilot cockpit: don't register the Timeline view into the Explorer (blank-canvas shell).
if (!ONEPILOT_HIDE_EXPLORER_EXTRAS) {
