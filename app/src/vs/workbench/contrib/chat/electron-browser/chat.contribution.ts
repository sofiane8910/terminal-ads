...
// Onepilot fork: desktop AI/chat is hidden — skip the agent-window actions, the voice-chat actions
// and their Cmd+I keybindings, the voice keyword (wake-word) listener, chat CLI/lifecycle handlers,
// and agent-host contributions. All are AI-only and dead while AI is hidden. See docs/strip.
if (!ONEPILOT_HIDE_AI) {
