...
// Onepilot fork: terminal chat UI is hidden. We keep ITerminalChatService registered (below) since
// it is widely consumed via DI; only the visible controller/accessibility/enabler are gated. docs/strip.
if (!ONEPILOT_HIDE_AI) {
