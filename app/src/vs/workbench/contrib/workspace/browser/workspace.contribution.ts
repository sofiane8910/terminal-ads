	...
	.registerConfiguration({
		...
		properties: {
			[WORKSPACE_TRUST_ENABLED]: {
				type: 'boolean',
				// Onepilot cockpit: Workspace Trust (Restricted Mode) off by default — every folder opens
				// fully trusted and natively editable, no safe-browsing banner. User-overridable.
				default: false,
