...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'workbench.startupEditor': {
			...
			// Onepilot fork: no VS Code welcome page on startup (a focused cockpit gets its own welcome
			// later; 'terminal' is a candidate default once the cockpit lands). See docs/strip.
			'default': 'none',
