...
import { ONEPILOT_HIDE_ONBOARDING } from '../../../../base/common/onepilot.js';
...
export class WalkthroughsService extends Disposable implements IWalkthroughsService {
	...
	private registerWalkthroughs() {
		...
		// Onepilot fork: do not register the built-in VS Code walkthroughs (Get Started / editor playground /
		// accessibility / web). The service stays available for extension- and remote-contributed walkthroughs.
		// See docs/strip/residual-audit.md.
		if (ONEPILOT_HIDE_ONBOARDING) {
			return;
		}
