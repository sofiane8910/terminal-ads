...
// Onepilot fork: keep the inline-chat session service registered — other features (empty-editor
// hints, notebook cell view-models, chat editing) depend on it via dependency injection. All
// user-visible inline-chat surfaces (the controller widget, Cmd+I/actions, notebook integration,
// accessibility help) are hidden behind the flag. See docs/strip.
