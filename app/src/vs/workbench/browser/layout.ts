...
class LayoutStateModel extends Disposable {
	...
	load(configuration: ILayoutStateLoadConfiguration): void {
		...
		// Onepilot cockpit: blank-canvas shell — primary side bar hidden on first run too. WORKSPACE-scoped,
		// so this only seeds fresh installs / newly-opened folders; later toggles persist. User-overridable.
