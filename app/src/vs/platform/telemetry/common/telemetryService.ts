...
configurationRegistry.registerConfiguration({
	...
	'properties': {
		[TELEMETRY_SETTING_ID]: {
			...
			// Onepilot fork: telemetry is OFF by default (privacy is a product principle). There are
			// also no telemetry endpoints configured in product.json, so no sender is initialized.
